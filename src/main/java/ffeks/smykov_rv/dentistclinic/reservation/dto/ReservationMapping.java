...
@Mapper(componentModel = "spring", uses = {DoctorMapping.class, AdministratorMapping.class, UserAccountMapper.class})
public interface ReservationMapping {
    ...
    @Mapping(target = "administrator", source = "administrator") // Chains AdministratorMapping
    @Mapping(target = "doctor", source = "doctor") // Already chained via DoctorMapping
